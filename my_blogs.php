...
if(!empty($_POST['publish_id'])){
    $id = $_POST['publish_id'];
    $blogger_id = $auth->user()->id;

    $blog = $database->table("blogs")->where("id","=",$id)->andWhere("blogger_id","=",$blogger_id)->executeWhere()->get();
    //dd($blog);
...
?>
        ...
        <div class="container">
            ...
            <div id="responsiveTabStructure">
                <ul class="tabs ml-3">
                    <li class="tab-name">
                        <a href="#my-blogs" id="my-blogs-name" class="">My Blogs</a>
                    </li>
                    <li class="tab-name">
                        <a href="#my-drafts" id="my-drafts-name">My Drafts</a>
                    </li>
                    <li class="tab-name">
                        <a href="#deleted-blogs" id="deleted-blogs-name">Deleted Blogs</a>
                    </li>
                    <!-- <li class="tab-name"><a href="#stats" id="stats-name">Statistics</a></li>
                    -->
                </ul>
...
?>
                                            <a
                                                ...
                                                onclick="document.forms.read_more<?= $blog->id?>.submit()"
                                                name=""
                                                value="">Read More</a>
                                            <?php
endif;
...
?>
                        ...
                        <div class="card-footer text-muted d-flex justify-content-between">
                            ...
                            <div class="d-inline-block">
                                <!-- <form action="index" id = "editForm" name = "editForm" method =
                                "POST"></form> -->
                                ...
                                <div class="d-inline-block">
                                    <form action="edit_blog.php" method="POST" name="edit_form<?= $blog->id?>">
                                        ...
                                        <a
                                            class="btn btn-primary fa fa-pencil edit-btn shadow"
                                ...
                                <div class="d-inline-block ">
                                    <form action="delete.php" method="POST" name="delete_form<?= $blog->id?>">
                                        ...
                                        <a
                                            class="btn btn-primary fa fa-trash delete-btn shadow"
...
?>
                        ...
                        <div class="card-footer text-muted d-flex justify-content-between">
                            <div class="d-inline-block date-format"></div>
                            <div class="d-inline-block">
                                <!-- <form action="index" id = "editForm" name = "editForm" method =
                                "POST"></form> -->
                                <div class="d-inline-block">
                                    <form action="my_blogs.php" method="POST" name="publish_form<?= $blog->id?>">
                                        ...
                                        <a
                                            class="btn btn-primary fa fa-check publish-btn"
                                            onclick="document.forms.publish_form<?= $blog->id?>.submit()"></a>
                                    </form>
                                </div>
                                <div class="d-inline-block ">
                                    <form action="edit_blog.php" method="POST" name="edit_form<?= $blog->id?>">
...
if($deletedBlogs == null):

    echo "No Deleted Blogs Present";
                        ...
                        <div class="card-footer text-muted d-flex justify-content-between">
                            ...
                            <div class="d-inline-block">
                                ...
                                <form action="my_blogs.php" name="blog<?= $blog->id?>" method="POST">
                                    ...
                                    <a
                                        class="btn upload-btn mr-2 ml-2 pr-3 pl-3"
                                        onclick="document.forms.blog<?= $blog->id?>.submit()"
                                        name=""
                                        value="">
